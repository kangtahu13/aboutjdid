...
class Curl {
    ...
    private function data()
	{
	    ...
	    {   $mailist=array('@sharklasers.com','@grr.la');
	    	...
	    	$email = $snama[0].mt_rand(11111,99999)."@sharklasers.com";
...
class jdClass
{
	...
	private function data()
	{
	    ...
	    {
	    	$snama = explode(" ", strtolower($name[1]));
	    	$email = $snama[0].mt_rand(11111,99999).mt_rand("@sharklasers.com,@guerrillamail.net");
	    	return array('name' => $name[1], 'email' => $email);
	    } else {
	    	return false;
	    }
...
echo"============================================================= \n";
    		...
    		while($i<$jumlah+1) {
    			   echo "Proses ke ".$i." dari ".$jumlah."\n";
					...
					$email = str_replace("@sharklasers.com","",$registerJD);
					$headers = array();
